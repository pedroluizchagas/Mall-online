...
| 8 | Conteúdo | Gestão de conteúdo + métricas | ✅ implementado (`5fcab8f`) |
| 9 | Conteúdo | Integração do feed real no consumer | ✅ implementado (`2a920a6`) — **programa completo (marco M3)**; DoD ponta a ponta pendente de device real + `db reset` |
