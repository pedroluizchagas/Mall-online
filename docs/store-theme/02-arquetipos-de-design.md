...
- **Traduções conscientes da referência:** o mockup tem um **coração de favorito** no card e **estrelas de avaliação**. Nenhum dos dois entrou: o app não tem lista de desejos nem rating de produto (um coração que não guarda nada mentiria para o cliente, e estrelas inventadas mentiriam sobre o produto). O canto do card ficou com o selo de oferta e a linha de baixo com a descrição: mesmos lugares, informação verdadeira. A **barra de navegação flutuante** do mockup virou a barra fixa da vitrine — desde 2026-08-26 toda loja mostra a régua do shell ([05 §5.6](05-aplicacao-storefront-consumer.md)), com a forma escolhida pelo DNA de cada arquétipo.
