...
Os **19 arquétipos** ([02](02-arquetipos-de-design.md)). Cada um tem **uma paleta default**; o eixo de paleta troca `bg/surface/ink/accent`. Quatorze vêm de referência; os cinco desenhados internamente são clinic/tech/market/utility/playful.
