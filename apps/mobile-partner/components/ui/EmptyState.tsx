 ...
 *
 * Spec: docs/system-design/consumer/03-componentes-base.md (port 1:1 — docs/system-design/partner/00-sistema.md §5) §7
 */
...
export function EmptyState({
  ...
  return (
    ...
    >
      ...
      >
        <PartnerIcon name={icone} size={36} color={colors.accent} strokeWidth={1.6} />
      </View>
