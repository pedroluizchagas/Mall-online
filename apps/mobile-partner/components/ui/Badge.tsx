 ...
 *
 * Spec: docs/system-design/consumer/03-componentes-base.md (port 1:1 — docs/system-design/partner/00-sistema.md §5) §4
 */
...
export function Badge({
  ...
  return (
    ...
    >
      {icone && (
        <PartnerIcon name={icone} size={tamIcone} color={corTexto} strokeWidth={2.2} />
      )}
      <Text
        style={{
          fontSize: fonte,
