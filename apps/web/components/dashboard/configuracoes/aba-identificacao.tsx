...
export function AbaIdentificacao({ loja, emailComercial }: Props) {
  const [estado, dispatch] = useFormState(atualizarDadosGerais, null)
  ...
  return (
    ...
    >
      <h2 className="font-semibold text-ink mb-1">Identificação da loja</h2>
      <p className="text-xs text-ink-3 mb-4">
        Identidade visual (logo, banner, descrição) é gerenciada em <strong>Minha Loja</strong>.
      </p>
      ...
      <form action={dispatch} className="space-y-4">
        ...
        <div>
          <label className="block text-sm font-medium text-ink-2 mb-1">Nome interno da loja</label>
          <input
            name="nome"
        ...
        <div>
          <label className="block text-sm font-medium text-ink-2 mb-1">Slug da loja</label>
        ...
        {emailComercial && (
          <div>
            ...
            />
            <p className="text-xs text-ink-3 mt-1">
              É o mesmo do seu cadastro pessoal. Para alterar, fale com o suporte.
            </p>
          </div>
        )}
