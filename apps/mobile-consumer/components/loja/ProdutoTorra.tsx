...
/**
 * PDP torra — o item em tela cheia com o calor do pôster.
 *
 ...
 * cafeteria os modificadores são comuns: leite, tamanho, extra shot), pele
 * roast: painel verde-floresta de cantos bem redondos, nome em caps
 * pesadas creme, preço âmbar e CTA em pill âmbar sólida de largura cheia.
 */
...
export function ProdutoTorra({ produto, loja, onFechar }: Props) {
    ...
    <Modal visible animationType="fade" onRequestClose={onFechar}>
      <View style={{ flex: 1, backgroundColor: colors.canvas }}>
        ...
        >
          ...
          >
            <ConsumerIcon name="back" size={22} color="#FFFFFF" strokeWidth={2.1} />
          </TouchableOpacity>
        ...
        {/* Marcadores + painel verde-floresta */}
        <View
          style={{
            position: 'absolute',
            left: 14,
        ...
        >
              ...
              {fotos.map((_, i) => (
                <View
                  ...
                  style={{
                    ...
                    borderRadius: 3,
                    backgroundColor:
                      i === fotoAtiva ? colors.accent : 'rgba(255,255,255,0.5)',
                  }}
                />
              ))}
            </View>
          ...
          >
            ...
            >
              ...
              {/* Pill âmbar sólida — o calor do balcão */}
              <Animated.View
        ...
        {/* Variações/modificadores por cima (leite, tamanho, extra shot...) */}
        {mostrarOpcoes && (
          <ModalProduto
            produto={produto}
            loja={loja}
