...
/**
 * Luz do dia — a folha clara do Início acompanha o sol.
 *
 ...
 * (cor, intensidade e onde o sol está); quem pinta é o VidroFosco da home,
 ...
 *
 * Spec: docs/system-design/consumer/07-telas.md §1 (folha → luz do dia)
 */

const { luz } = consumerDesign
